...
class KGTableRetriever(BaseRetriever):
    ...
    def __init__(
        ...
        max_keywords_per_query: int = 5,       #我改的
    ...
    def _retrieve(
        ...
        if (
            ...
            for top_rel_text in top_rel_texts:
                if top_rel_text not in rel_texts:
                    rel_texts.append(top_rel_text)
            if self._include_text:
