...
triplets_dict = {
    0: [
        ("员工", "一类地区住宿费", "400元/天"),
        ("公司中层", "一类地区住宿费", "600元/天"),
        ("公司副总经理", "一类地区住宿费", "800元/天"),
        ("总法律顾问", "一类地区住宿费", "800元/天"),
        ("总工程师", "一类地区住宿费", "800元/天"),
        ("研究院院长", "一类地区住宿费", "800元/天"),
        ("公司领导", "一类地区住宿费", "1000元/天"),
        ("员工", "二类地区住宿费", "350元/天"),
        ("公司中层", "二类地区住宿费", "500元/天"),
        ("公司副总经理", "二类地区住宿费", "800元/天"),
        ("总法律顾问", "二类地区住宿费", "800元/天"),
        ("总工程师", "二类地区住宿费", "800元/天"),
        ("研究院院长", "二类地区住宿费", "800元/天"),
        ("公司领导", "二类地区住宿费", "1000元/天"),
        ("员工", "三类地区住宿费", "300元/天"),
        ("公司中层", "三类地区住宿费", "400元/天"),
        ("公司副总经理", "三类地区住宿费", "800元/天"),
        ("总法律顾问", "三类地区住宿费", "800元/天"),
        ("总工程师", "三类地区住宿费", "800元/天"),
        ("研究院院长", "三类地区住宿费", "800元/天"),
        ("公司领导", "三类地区住宿费", "1000元/天")
    ],
    1: [
        ("一类地区", "包含", "北京"),
        ("一类地区", "包含", "上海"),
