...
def process_file(input_file, file_metadata, file_extractor, filename_as_id, errors, encoding, supported_suffix):
    metadata = None
    ...
    if (
        file_suffix in supported_suffix
        ...
        # do standard read
        with open(
            input_file, "r", errors=errors, encoding=encoding
        ) as f:
            data = f.read()
...
class SimpleDirectoryReader(BaseReader):
    ...
    def load_data(self) -> List[Document]:
        ...
        for input_file in tqdm(self.input_files):
            ...
            if (
                ...
                doc = Document(text=data, metadata=metadata or {}, file=str(input_file))
                if self.filename_as_id:
                    doc.id_ = str(input_file)
    ...
    # def load_data(self) -> List[Document]:
    #     """Load data from the input directory using multiprocessing for parallel processing.
    #
    #     Returns:
    #         List[Document]: A list of documents.
    #     """
    ...
    #
    #     # Use multiprocessing to parallelize the loading of data
    #     load_data_func = partial(process_file,
    #                              file_metadata=self.file_metadata,
    #                              file_extractor=self.file_extractor,
    #                              filename_as_id=self.filename_as_id,
    #                              errors=self.errors,
    #                              encoding=self.encoding,
    #                              supported_suffix=self.supported_suffix)
    #     documents = list(tqdm(pool.imap(load_data_func, self.input_files), total=len(self.input_files)))
    #     pool.close()
    #     pool.join()
    #
    #     return [doc for doc_list in documents for doc in doc_list]
